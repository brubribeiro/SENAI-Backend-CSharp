    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            #region Trabalhar com tabulação
                ...
                // Adiciona um texto ao parágrafo com tabulção
                ...
                // Adiciona um texto ao parágrafo texto2Capa com concatenação
                texto2Capa.AppendText("\tBasicamente ,então, uma seção representa uma página do documento e os parágrafos dentro de uma mesma seção, " + "obviamente, aparecem na mesma página");
            #endregion
            ...
            #region Adicionar nova seção
                ...
                // Adiciona parágrafo à seção secaoCorpo
                Paragraph paragrafoCorpo1 = secaoCorpo.AddParagraph();

                // Adiciona um texto ao parágrafo paragrafoCorpo1
                paragrafoCorpo1.AppendText("\tEste é um exemplo de um parágrafo criado em uma nova seção." + "\tComo foi criado uma nova seção, perceba que este texto aparece em uma nova página.");
            #endregion
            ...
            #region Adicionar uma tabela
                ...
                String[] cabecalho = {"Item","Descrição","Quant.","Preço Unit.","Preço"};
